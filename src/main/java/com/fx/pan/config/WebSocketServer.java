...
import com.fx.pan.utils.JSONParse;
...
public class WebSocketServer {
    ...
    private static ConcurrentHashMap<String, WebSocketServer> tokenMap = new ConcurrentHashMap<>();
    ...
    public void onOpen(Session session) {
        ...
        String uid = StringUtils.getParamByUrl(requestURI.toString(), "uid");
        String fid = StringUtils.getParamByUrl(requestURI.toString(), "fid");
        String userName = StringUtils.getParamByUrl(requestURI.toString(), "username");
    ...
    public void onMessage(String message) {
        ...
        for (String key : tokenMap.keySet()) {
            if (!key.equals(userId)) {
                WebSocketServer socketServer = (WebSocketServer) tokenMap.get(key);
